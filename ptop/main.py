...
def main():
    ...
    parser.add_argument('--system-info-poll', type=float, default=2.0,
                       help='System info live fields poll interval in seconds (default: 2.0). Controls how often disk usage, uptime, etc. are refreshed.')
